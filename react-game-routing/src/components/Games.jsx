...
const games = [
    {
        id: 1, 
        image:'/src/assets/Red-Dead-I.jpg',
    ...
    {
        id: 2, 
        image: '/src/assets/Red-Dead-II.jpg',
    ...
    {
        id: 3, 
        image:'/src/assets/GTA_Vice-City.jpg',
    ...
    return (
        <>
            ...
            <ul>
                {
                    games.map((game) => (
                        <li key={game.id} className="game-li">
