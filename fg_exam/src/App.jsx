...
function App() {
  return (
    <div>
      <Header  />
      <Body KeyBoardName =" KB X1000" OverView= "The KB-X1000 is a high-performance mechanical keyboard designed for gamers, professionals, and everyday users who demand precision and comfort. It features customizable RGB backlighting, durable mechanical switches, and programmable keys to enhance your typing and gaming 
experience."
 Specifications = "● Switch Type: Cherry MX Red (Mechanical)
● Key Layout: Full-size (104 keys) <br></br>
● Backlighting: RGB with customizable colors
● Connectivity: Wired (USB 2.0)
● Dimensions: 440 mm x 135 mm x 35 mm
● Weight: 1.2 kg
● Cable Length: 1.8 meters
● Additional Features: Anti-ghosting, N-key rollover, dedicated media controls" InsideBox = "● KB-X1000 Keyboard
● USB Cable
● User Manual
● Keycap Removal Tool
● Warranty Card"
KeyFeatures ="Customizable RGB Backlighting: Personalize the keyboard’s illumination with a wide range of colors 
...
Troubleshoot = "Keyboard Not Responding:
